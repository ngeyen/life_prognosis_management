...
public class Docs {
         ...
         */
        public static void showHelp(UserRole userRole) {
                if (UserRole.ADMIN == userRole) {
                        System.out.println("\nHelp Menu");
                        System.out.println("=========================");
                        System.out.println(
                                        "1. Create new patient: Allows an admin to register a new patient by entering their details.");
                        ...
                        System.out.println(
                                        "4. Download Patient Analytics: Exports patient statistics and analytics to a CSV file.");
                        ...
                        System.out.println(
                                        "3. Recalculate Survival Rate: Recalculates your survival rate based on the latest data.");
